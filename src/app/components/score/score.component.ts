...
const TABLE_DATA: object[] = [
  {icon: "Icon1", title: "Shopping", content: "Medical"},
  {icon: "Icon2", title: "Monthly Salary", content: "Income"},
...
export class ScoreComponent implements OnInit {
  ...
  constructor(private scoresStoreService: ScoresStoreService) {
    ...
    this.scoreOverall = this.DATA['score_overall'];
    this.currentPageValues = [
        this.DATA['score_medical'],
        this.DATA['score_income'],
        this.DATA['score_stuff'],
        this.DATA['score_liability'],
        this.DATA['score_digital'],
    ];
  ...
  //   [id, user_id, overall, ...this.currentPageValues] = this.DATA[this.slideIndex - 1];
  //   this.updateGraph(this.cx, this.cy);
  //   this.totalValue = this.sumValues(this.currentPageValues);
  //
